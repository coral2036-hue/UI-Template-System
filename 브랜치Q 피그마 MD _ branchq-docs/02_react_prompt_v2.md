...
/modals        — Modal 8종 (ModelSelect, ApiSetting, Share, KakaoPreview, Email, Confirm, MMS, KakaoAlimtalk)
/share         — PhoneMockup, KakaoMockup, AlimtalkBubble (공용 목업)
/email         — RecipientSelector, QAPreviewRenderer, AttachmentManager
/pages         — DetailView (/detail/:responseId 답변 상세 화면)
/builder       — UI 빌더/제너레이터
...
- outside click close
- focus return
- → 00_master#modal-contract (M1~M8) 참조
- M5/M7/M8: createPortal 사용 (#modal-root, 모바일 430px 제약 밖)
